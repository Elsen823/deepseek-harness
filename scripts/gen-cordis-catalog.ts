...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  appRestart: 'not a service: launcher-provided explicit process-restart callback — packages/boot/cmdline/README.md owns the launcher contract',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AgentDriver: 'core.md',
  AgentDriverId: 'core.md',
  AgentDriverInfo: 'core.md',
  AgentDriverContribution: 'core.md',
  AgentHandle: 'core.md',
  ...
  SessionRuntimeActivation: 'session.md',
  SessionRuntimeActivationSpec: 'session.md',
  SessionRuntimeAttention: 'session.md',
  SessionRuntimeAttentionKind: 'session.md',
  SessionRuntimeAvailability: 'session.md',
  SessionRuntimeDetail: 'session.md',
  SessionRuntimeStatus: 'session.md',
  SessionRuntimeUnavailableReason: 'session.md',
  SessionId: 'core.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  RestartHandoffOptions: 'restart handoff request is owned by packages/core/agent/README.md',
  RestartHandoffResult: 'restart handoff result is owned by packages/core/agent/README.md',
  AdoptRestartHandoffsOptions: 'restart handoff adoption request is owned by packages/core/agent/README.md',
  AgentHandoffAdoption: 'restart handoff adoption result is owned by packages/core/agent/README.md',
