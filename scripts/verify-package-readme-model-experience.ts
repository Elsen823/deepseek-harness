...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/todo/todo': { kind: 'none', reason: 'The provider only derives a client-facing projection from already-logged Session events.' },
  ...
  'packages/session/session-runtime': { kind: 'none', reason: 'The process-local runtime registry projects availability and attention to Host, Web, and SDK consumers without changing model requests.' },
  ...
  'packages/goal/objective': { kind: 'none', reason: 'The Objective unit folds already-durable Session facts into a client-facing read model and registers nothing model-facing.' },
  'packages/plan/plan-proposal': { kind: 'none', reason: 'The Proposed Plan unit folds already-durable document facts into a client-facing read model and registers nothing model-facing.' },
