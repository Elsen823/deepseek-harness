...
Source: [`packages/core/agent-loop/src/index.ts:149`](../packages/core/agent-loop/src/index.ts)
...
Depends on: `Options` (`@anthropic-ai/claude-agent-sdk`)

Source: [`packages/extensions/claude-agent-driver/src/index.ts:30`](../packages/extensions/claude-agent-driver/src/index.ts)
...
Source: [`packages/host/frontend-static/src/index.ts:36`](../packages/host/frontend-static/src/index.ts)
