...
export interface AssistantMessageNode {
  ...
  /** Prefix of an aborted turn, rendered with the localized stopped marker. A durable
...
/** Send/stop failure surfaced in the input error strip; op selects the matching localized copy. */
