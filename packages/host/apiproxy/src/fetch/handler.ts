...
import {
  ...
  hostListDirectoryRequestSchema, hostOpenPathRequestSchema, hostRestartRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.restart': { schema: hostRestartRequestSchema, invoke: (api, r) => api.host.restart(r) },
