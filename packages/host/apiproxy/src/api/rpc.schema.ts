...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('agent-driver-not-found'), message: z.string(), details: z.object({ driverId: z.string() }) }),
  z.object({ code: z.literal('agent-driver-conflict'), message: z.string(), details: z.object({ sessionId: z.string(), requestedDriverId: z.string(), existingDriverId: z.string() }) }),
  z.object({ code: z.literal('invalid-time-zone'), message: z.string(), details: z.object({ value: z.string() }) }),
  z.object({ code: z.literal('workspace-attach-failed'), message: z.string(), details: z.object({ sessionId: z.string(), workspaceId: z.string(), driverId: z.string() }) }),
