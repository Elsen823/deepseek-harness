...
function bench(options: {
  ...
  const childHeader = {
    version: 0, driverId: AgentDriverId('dsh'), id: CHILD, createdAt: 1, cwd: '/proj', parentSession: options.historyParent ?? PARENT,
  ...
  ctx.provide('agents', {
    get: getAgent,
    restartHandoffPhase: 'active',
    admitRestartOperation: () => () => {},
  })
