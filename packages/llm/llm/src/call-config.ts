 ...
 * model, reasoning effort, service tier, and sampling values are request-header
 * state that can affect cache reuse; request waterfalls replace them and the loop logs
